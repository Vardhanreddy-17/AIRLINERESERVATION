...
<meta charset="UTF-8">
<title>Flivan</title>
<link type="text/css" rel="stylesheet" href="css/Booktickets.css">
</head>
<!DOCTYPE html>
<html>
<head>
        ...
        <form>
          <div class="products">
            ...
            <div class="item">
              ...
              <p class="item-name">Flight 1</p>
              <p class="item-description">BOOK TICKET</p>
            </div>
            <div class="total">Total<span class="price">10000</span></div>
          </div>
